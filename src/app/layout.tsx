...
export const metadata: Metadata = {
  ...
  verification: {
    google: "vZ94tKEZHZLLls5XJbwxl0J6FzXeL7AE9kyb3bqFLkI",
  },
};
  ...
  return (
    <html lang="en" className={`${inter.variable} ${montserrat.variable}`}>
      <body className="min-h-screen flex flex-col">
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-NHDNLBQF"
            height="0"
            width="0"
...
})(window,document,'script','dataLayer','GTM-NHDNLBQF');`}
        </Script>
...
})(window, document, "clarity", "script", "wwnna89nz3");`}
        </Script>
      </body>
    </html>
  );
